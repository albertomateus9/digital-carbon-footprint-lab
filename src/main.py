...
PROJECT = {
  "code": "P16",
  "slug": "digital-carbon-footprint-lab",
  "title": "Pegada De Carbono Digital Da Turma",
  "discipline": "Transformacao Digital I E Educacao Ambiental",
  "disciplinePt": "Transformacao Digital I E Educacao Ambiental",
  "kind": "carbon",
  "dataset": "Amostra segura local",
  "source": "Amostra sintetica local",
  "description": "Calculo didatico de emissao estimada por uso digital com ranking sintetico.",
  "topics": [
    "data-science",
    "python",
    "jupyter-notebook",
