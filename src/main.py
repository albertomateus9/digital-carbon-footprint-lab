...
PROJECT = {
  ...
  "title": "Digital Carbon Footprint Lab",
  ...
  "kind": "carbon",
  "dataset": "Synthetic digital habit survey sample",
  "source": "Local synthetic sample",
  "description": "Digital carbon footprint lab using fictional device and streaming usage data.",
  "concepts": [
